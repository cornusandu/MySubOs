...
int main(int argc, char **argv) {
    ...
    data d = load_file(filename);
    std::byte* content = d.content;
    uint8_t buffer_size = d.size;

    CPU cpu;
    cpu.execute(content, buffer_size);
